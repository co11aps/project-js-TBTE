import{h as S,u as C,c as T,a as j,b as q}from"./assets/apple-books-logo-5f0bb382.js";import{a as g,i as _}from"./assets/vendor-25a77764.js";const y=document.getElementById("to-top-button");window.addEventListener("scroll",()=>{window.pageYOffset>100?y.classList.add("active"):y.classList.remove("active")});y.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});function L(){window.scrollTo({top:0,behavior:"smooth"})}const v=document.querySelector(".loader");function m(){v.classList.remove("hidden")}function l(){v.classList.add("hidden")}const p="https://books-backend.p.goit.global/books";async function H(){const o=`${p}/category-list`;return(await g.get(o)).data}async function f(){const o=`${p}/top-books`;return(await g.get(o)).data}async function $(o){o=o.trim();const t={category:o},e=`${p}/category`;return(await g.get(e,{params:t})).data}async function E(o){o=o.trim();const t=`${p}/${o}`;return(await g.get(t)).data}let b;const c=document.querySelector(".main-content");function I({_id:o,author:t,contributor:e,title:a,book_image:s,list_name:i}){return b=i,`<li class="book-li-item">
  ...
  >${e.splice(0,e.length/2).join(" ")} <span class="block_books-colortitle">${e.splice(e.length/2,e.length).join(" ")}</span></h2> 
    ...
    <p class="books_info-author">${o}</p>  
            ...
            </div>`}function N(o){C(!T(o._id));const t=J(o);M.insertAdjacentHTML("afterbegin",t)}async function X(){m();try{const o=await H();z(o)}catch(o){r(o)}l()}w.addEventListener("click",W);c.addEventListener("click",K);X();
