import"./assets/dark-theme-2c30d300.js";const d="storage-of-books";JSON.parse(localStorage.getItem(d));const g="/project-js-TBTE/assets/books-stack-mobile-487658af.png",c="/project-js-TBTE/assets/books-stack-a8e7c57b.png",i="storage-of-books",a=document.querySelector(".shopping-list"),r=document.createElement("div");r.classList.add("empty-message");r.innerHTML=`
