import"./assets/buttom-switch-1045498d.js";const n="storage-of-books";JSON.parse(localStorage.getItem(n));const c="storage-of-books",r=document.querySelector(".shopping-list"),s=document.createElement("div");s.classList.add("empty-message");s.innerHTML=`
